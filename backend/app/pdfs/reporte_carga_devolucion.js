function devolucion(carga, nrocarga){
    return new Promise((resolved, reject) =>{
      ...
      if(carga.length > 0){
        ...
        content.push({ fontSize: 12, bold: true, alignment: 'center', text: 'LISTA DEVOLUCION DE CARGA' });
        content.push({
          columns: [
        ...
        content.push({ fontSize: 12, bold: true, alignment: 'center', text: 'LISTA DEVOLUCION DE CARGA' });
        content.push({ fontSize: 9, text: 'No se encontro devolucion en el sistema. ' + nros, italics: true });
