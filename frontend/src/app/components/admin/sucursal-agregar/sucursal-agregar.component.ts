  ...
  agregarSucursal(){
    ...
    else
    {
      ...
      let parametros = {
        ...
        'foto': 'sin_imagen_sucursal.jpg', 'id_empresa': localStorage.getItem("id_empresa"), 'id_rol': localStorage.getItem("id_rol"),
        'hr_id_usuario': localStorage.getItem("id_usuario"), 'hr_dispositivo': 'windows one', 'hr_latitud': 0, 'hr_longitud': 0
      };
